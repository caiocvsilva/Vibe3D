...
class CasiaB(Dataset):
    def __init__(self, seqlen, subset='train'):
        ...
        print(f'CasiaB dataset number of videos: {video_count}')
        print(f'CasiaB dataset number of used videos: {valid_video}')
        print(f'CasiaB dataset number of video pieces: {len(self.vid_indices)}')
